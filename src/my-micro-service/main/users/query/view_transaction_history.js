...
const view_transaction_history = async (args, req, user) => {
    try {
        let transHistory = await db.transactions
            ...
            .lean()
            .exec();
        Error_Handler_1.default(transHistory === null, "no transactions found");
...
exports.default = view_transaction_history;
